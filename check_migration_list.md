...
| --- | --- | --- | --- |
| [Avoid default table keys](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/avoid-default-key.md) | TBM | yes | |
| [Boolean input parameter](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/boolean-input-parameter.md) | TBM | no | |
| [CALL METHOD usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/call-method-usage.md) | TBM | yes | |
| [Chain declaration usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/chain-declaration-usage.md) | TBM | yes | |
| [CHECK statement position](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/check-statement-position.md) | TBM | yes | |
| [CHECK in LOOP](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/check-in-loop.md) | TBM | yes | |
| [COLLECT usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/collect.md) | TBM | no | not relevant for ABAP Cloud (`COLLECT` is forbidden) |
| [Combination of output parameters](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/method-output-parameter.md) | TBM | no | |
...
| [Constant interface](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/constants-interface.md) | TBM | no | |
...
| [Database access in unit tests](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/db-access-in-ut.md) | TBM | perhaps | The quick fix here would be rather complex: Create the statements necessary to create an SQL test double instance for the database tables accessed |
...
| [Deprecated key words](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/deprecated-key-word.md) | TBM | yes | This check should be merged with other checks that also look for deprecated key words (see below) |
...
| [Empty IF branches](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/empty-if-branches.md) | TBM | yes | |
...
| [Assignment chaining](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/equals-sign-chaining.md) | TBM | yes | |
...
| [FORM usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/form-routine.md) | TBM | no | not relevant for ABAP Cloud (`PERFORM` is forbidden) |
| [FUNCTION usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/function-routine.md) | TBM | no | not relevant for ABAP Cloud (non-RFC function module cannot be used anyway) |
...
| [Message easy to find](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/message-easy-to-find.md) | TBM | perhaps | |
...
| [Missing interface](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/interface-in-class.md) | TBM | no | Creating a new global interface is not currently possible via the quick fix API |
...
| [Number of output parameters](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/number-output-parameter.md) | TBM | no | Should be merged with "Combination of output parameters" check |
| [Prefer CASE to ELSEIF](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/prefer-case-to-elseif.md) | TBM | yes | |
| [Prefer RETURNING to EXPORTING](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/prefer-returning-to-exporting.md) | TBM | yes | |
| [Prefer IS NOT to NOT IS](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/prefer-is-not-to-not-is.md) | TBM | yes | |
| [Prefer line_* over READ TABLE/LOOP AT ... WHERE](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/prefer-line-exists.md) | TBM | yes | Consider merging into "deprecated keywords" |
| [Prefer NEW to CREATE OBJECT](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/prefer-new-to-create-object.md) | TBM | yes | Consider merging into "deprecated keywords" |
...
| [Omit optional EXPORTING](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/omit-optional-exporting.md) | TBM | yes | Consider merging into "CALL METHOD usage" | 
| [Optional parameters](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/optional-parameters.md) | TBM | no | |
...
| [RECEIVING usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/receiving-usage.md) | TBM | yes | Consider merging into "CALL METHOD usage" |
| [Returning name](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/returning-name.md) | TBM | yes | |
| [Scope of variable](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/scope-of-variable.md) | TBM | yes ||
| [Self-reference](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/self-reference.md) | TBM | yes | |
| [TEST-SEAM usage](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/test-seam-usage.md) | TBM | yes | |
| [Text assembly](https://github.com/SAP/code-pal-for-abap/blob/master/docs/checks/text-assembly.md) | TBM | yes | |
