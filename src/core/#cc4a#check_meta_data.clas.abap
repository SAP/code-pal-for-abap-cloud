...
public section.
  ...
  types:
    ...
    "!
    "! Extend this enum with new variants if a check needs additional functionality in the target system besides the standard
    "! Code Inspector infrastructure to analyze ABAP code.
